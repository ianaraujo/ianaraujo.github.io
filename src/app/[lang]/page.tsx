...
const getPosts = async (): Promise<PostMeta[]> => {
  ...
  const posts = filenames
    ...
    .filter(
      (post) => post.date && typeof post.date === "string" && post.date.includes("/")
    );
        ...
        <div className="space-y-10">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-2 space-y-1">
                    <div className="flex items-center gap-3">
                      <h3 className="text-base font-semibold">Cientista de Dados</h3>
          ...
          <section>
            ...
            {posts.length > 3 && (
              <div className="mt-6">
                <Link href={`/${lang}/blog`}>
                  <span className="text-zinc-600 hover:underline">Ver todas publicações</span>
                </Link>
              </div>
            )}
          </section>
